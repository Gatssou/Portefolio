...
let projects = [
  {
    image: 'textures/affiche1.png',
    url: '#',
  },
  {
    image: 'textures/affiche2.png',
    url: '#',
  },
  {
    image: 'textures/affiche3.png',
    url: '#',
  },
  {
    image: 'textures/affiche4.png',
    url: '#',
  },
];
let aboutCameraPos = {
...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry('Gatssi Gatsso', {
      font: font,
      size: 0.08,
      height: 0.01,
    });
  ...
  loader.load('fonts/helvatica.json', function (font) {
    ...
    const subTitleGeo = new TextGeometry(
      'Web Designer / Developper / Content Creator',
      {
        font: font,
        size: 0.018,
        height: 0,
